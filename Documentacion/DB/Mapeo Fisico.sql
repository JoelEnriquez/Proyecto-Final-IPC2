...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`CLIENTE` (
  ...
  INDEX `fk_CLIENTE_USUARIO1_idx` (`codigo_cliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`CUENTA` (
  ...
  `codigo_cliente` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_CUENTA_CLIENTE1_idx` (`codigo_cliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`EMPLEADO` (
  ...
  INDEX `fk_EMPLEADO_TURNO_TRABAJO1_idx` (`codigo_turno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`TRANSACCION` (
  ...
  PRIMARY KEY (`codigo`),
  INDEX `fk_Transaccion_Cuenta1_idx` (`codigo_cuenta` ASC) VISIBLE,
  INDEX `fk_TRANSACCION_EMPLEADO1_idx` (`codigo_cajero` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`HISTORIAL_CAMBIOS` (
  ...
  PRIMARY KEY (`codigo`),
  INDEX `fk_HISTORIAL_CAMBIOS_USUARIO1_idx` (`codigo_usuario` ASC) VISIBLE,
  INDEX `fk_HISTORIAL_CAMBIOS_EMPLEADO1_idx` (`codigo_gerente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`LIMITE_REPORTES` (
  ...
  INDEX `fk_LIMITE_REPORTES_EMPLEADO1_idx` (`codigo_gerente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`SOLICITUD_ASOCIACION` (
  ...
  `codigo_cliente` INT NOT NULL,
  PRIMARY KEY (`codigo`),
  INDEX `fk_SOLICITUD_ASOCIACION_CUENTA1_idx` (`codigo_cuenta` ASC) VISIBLE,
  INDEX `fk_SOLICITUD_ASOCIACION_CLIENTE1_idx` (`codigo_cliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ProyectoFinal`.`ASOCIACION_CUENTA` (
  ...
  INDEX `fk_ASOCIACION_CUENTA_CLIENTE1_idx` (`codigo_cliente` ASC) VISIBLE,
