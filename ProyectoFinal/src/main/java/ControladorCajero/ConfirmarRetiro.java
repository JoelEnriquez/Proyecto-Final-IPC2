 ...
 * @author joel
 */
@WebServlet(name = "ConfirmarRetiro", urlPatterns = {"/ConfirmarRetiro"})
public class ConfirmarRetiro extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cuentaModel.debitarMonto(monto, cuentaDepositar);
        ...
        Time.valueOf(LocalTime.now()), "DEBITO", monto, cuentaModel.devolverMontoActual(cuentaDepositar),
